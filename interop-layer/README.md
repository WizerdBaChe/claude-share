...
| 目標端 | 生成位置 | 狀態 |
|---|---|---|
| opencode | `~/.config/opencode/AGENTS.md` | **唯一啟用中**,profile `light` |
| codex | `~/.codex/AGENTS.md` | **同步關閉**(2026-08-11 裁定,由 codex 端手動維護) |
| Antigravity | `~/.gemini/AGENTS.md` | **同步關閉**(2026-08-11 裁定,已不使用) |
...
1. **單向,永遠單向。** `~/.claude` 是唯一正典源;目標端的 AGENTS.md 是
   ...
   在 opencode 學到的教訓,回頭改正典源(CLAUDE.md / portable-core.md),再向外編譯。
