...
4. **No duplicate mechanisms**: before proposing new machinery, check what
   ...
   If nothing internal covers it, two more layers before building: (layer 2)
   quick search for existing community solutions (≤10 min; none found → note
   it, move on); (layer 3) state where their assumptions break in OUR context
   — that diff IS
