...
| First session in a project; where tickets/progress live; ledger templates; slicing plans into tickets; work-card format (施工卡); project domain glossary | `ops/60-bootstrap.md` |
