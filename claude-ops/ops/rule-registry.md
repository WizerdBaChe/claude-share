...
- evidence: SSLD `T46_檢討與放置契約_20260908/SSLD-T43-T45檢討_根因診斷與修正方向_
  20260908.md` (§1 A1 DOM read n_clip_ids=15; §1 A3; §1 B1; §4.1–4.2); a local
  session's ledger rows 6–7, 9–10; lesson L-059 +
...
- history: 2026-09-04 candidate drafted (status "raise after SSLD L4 round");
  ...
  the user's ruling (recorded in that session's ledger) — this history line still said "await
...
- why: user ruling. L-numbers measure RELAXATION, not rigor — L0 is strictest.
  **Origin, backfilled 2026-09-11** (found by session-archive mining; not
  ...
  model-side convenience. 2026-07-09, in one
  local session, two turns apart — first the cost
...
- evidence: `tools/process-ledger/controls.py` 31/31 and
  ...
  300k notice and its snapshot verified end-to-end in a local session.
