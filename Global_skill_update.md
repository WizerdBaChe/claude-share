...
- Context: user maintains a duplicate of this skill in the public share repo (this repo, `skill-toolkit/skills/scientific-research-guide/`) for editing outside the source environment; asked to verify the copy's new changes against skill conventions, clean up as needed, and sync back.
...
- `vendor/threejs/` (upstream `cloudai-x/threejs-skills`) deliberately **not
  ...
  the asset-library registry path was generalized (machine-specific,
