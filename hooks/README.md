...
> **2026-09-12 refresh（source 27196ab -> 7c9867b）：二十支掛載 hook。**
...
> manifest 的 `[[not_shipped]]`。`hooks/literature_host_guard.py`、
> `hooks/literature-host-policy.json`、`hooks/tests/test_literature_host_guard.py`
> **不是這輪加的**，是另一個並行工作項目的範圍。
